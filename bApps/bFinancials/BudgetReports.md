...
>
> **Step 2:** Add new description Budget Code and placeholder cell for Budget Code. See row 36 below.
>
> **Step 3:** Expand the Column Definitions section.
>
> **Step 4:** Fill in the appropriate cell in the column definitions section. In the below example it is row 7 column H. The formula should point to the Budget Code cell in the header. A good practice is to write the formula =IF(H36=””,””,H36).
...
>
> **Note:** To see available Budget Codes, go to the COA Segment Lookup report from the report library. Then choose the "InterjectSegment" tab and select the BudgetCode segment and pull the data.
>
>
>
>
