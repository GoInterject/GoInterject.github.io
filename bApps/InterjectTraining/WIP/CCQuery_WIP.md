...
* **District** - *Optional*. Blank defaults to all districts you have rights too. Works with individual districts, district ranges, and groupings
* **PO #** - *Optional*. Blank pulls all POs, format needs to be XXXX-X
...
The *Summary Level* drop-down input parameter shows the Capital changes, grouped by either the day or by the ChangeIDs. 

So if a PO changes multiple times in one day, the *By Day* option will show the final PO change for the day. If *By Change* is selected, it would show all of the changes made on that day.
