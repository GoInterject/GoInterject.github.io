...
To confirm the API is working, navigate to the host name or port you set up [previously](#set-up-website-in-iis) and access the status endpoint ("api/v1/status"). You should see "true" if the API is working.
