...
You are ready to modify the report to use your new data portal. The changes are simple since you only need to use a new function, [jDataPortal()](/wFunctions/jDataPortal.html), to specify the data portal record set number for each report function.
