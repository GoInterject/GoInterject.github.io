...
|  OnPullSaveOrBoth  |  "Pull"  |  A pull or save action are designated as the run event.  |  
|  OnClearRunOrBoth  |  "Both"  |  A run event (defined in OnPullSaveOrBoth) will trigger this function being ran.  |  
