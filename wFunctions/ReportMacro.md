...
The ReportMacro function executes a designated VBA macro when triggered upon a designated [event](/wFunctions/Event-Functions-Landing.html). 

For an example of this function, see [Lab Create: Using Report Macro](/wGetStarted/L-Create-ReportMacro.html)

###  Function Arguments

<button class="collapsible-parameter">**OnPullSaveOrBoth**<br>A string that defines what type of action(s) the event in OnClearRunOrBoth refers to: **Pull** action, **Save** action, or **Both** actions.</button>
