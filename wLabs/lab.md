...
In order to have the necessary requirements to go through the Lab Guide, a user needs to be subscribed to the "Training Demo" app. To request a subscription, contact us at [info@gointerject.com](mailto:info@gointerject.com). Once subscribed, a user can access all the labs in this guide:
...
This lab will give you an understanding of how the Interject Add-in can be used with Excel in real world scenarios. It will give you a meaning and purpose for the labs. For more overview, see [Real-World Examples](/wAbout/Real-World-Walkthroughs.html).
