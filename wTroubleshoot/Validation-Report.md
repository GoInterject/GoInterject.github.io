...
By selecting any of the validation options, you can view the code behind each action. Detailed information is given for selected ranges, data portals, parameters, formatting codes, and more. This helps users learn as well as diagnose code problems.
...
* **Action** : Lists the name of the function and its location in the report. (Functions will be run in the order they appear.)
