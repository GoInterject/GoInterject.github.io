    ...
    $.each(result, function(i, field){
      if ( field.name == interjectVersion && field.current ) {
        ...
        if ( field.current && buttonCode == null ) {
          ...
          listItems.push('<li role="presentation"><a role="menuitem" tabindex="-1" href="https://docs.gointerject.com/">' + prettyName + '</a></li>');
        } else {
          listItems.push('<li role="presentation"><a role="menuitem" tabindex="-1" href="https://docs.gointerject.com/' + field.name + '/">' + prettyName + '</a></li>');
        }
      }
    });
